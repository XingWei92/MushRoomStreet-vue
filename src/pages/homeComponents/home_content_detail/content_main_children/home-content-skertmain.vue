...
export default {
  ...
  data(){
    return {
      showData:[],
      clickText:['热卖新品','美裙套装','半身裙','连衣裙','针织裙','百褶裙','卫衣裙','背心裙','小黑裙','皮裙','气质长裙','背带裙','衬衫裙'],
      fcidArr:[50024,50046,50047,50045,50098,50107,10055779,10060185,10055428,50196,50054,50088,50092],
      fcids:"50045",
      flag:[true,false,false,false,false,false,false,false,false,false,false,false,false],
    }
  },
  ...
  created(){
    var page=1;
    var fcid=this.fcids;
    this.$http.jsonp('http://list.mogujie.com/search?action=&cKey=h5-cube-default-v1&cpc_offset=&fcid='+fcid+'&imageSize=220x330&maxPrice=20000&minPrice='+page).then(response=>{
  ...
  mounted(){
    ...
    $(function(){
      $(window).scroll(function(){
        ...
        //获取视窗高度
        // console.log($('.content_app').scrollTop());
        var fcid=that.fcids;
